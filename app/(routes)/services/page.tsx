...
const ServicesPages=() =>{
    return(
      ...
      <div className="Page-service">
        <div className="max-w-[550px] z-10 mt-3 md:mt-0:">
        ...
        <button className="px-3 py-2 rounded-lg bg-secondary opacity-75 hover:bg-secondary/80">Contacta conmigo</button>
                </div>
